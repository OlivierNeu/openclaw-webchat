...
// Reuse the CANONICAL fixtures from the backend test suite, VERBATIM, read
// relatively from this file -- the single source of truth for the spec, shared
// with backend/tests/test_normalizer.py. (<repo>/bridge/test -> ../../backend.)
const FIXTURES_PATH = resolve(
  __dirname,
  "../../backend/tests/fixtures/openclaw_frames.json",
);
